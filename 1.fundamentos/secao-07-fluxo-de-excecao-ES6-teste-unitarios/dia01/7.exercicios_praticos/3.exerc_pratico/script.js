...
//bonus:Utilizando o objeto (allLesson), crie uma função para contar quantos estudantes assistiram às aulas de Matemática.
...
const getNumberOfStudentsMath = (obj) => {
  ...
  for (index in keys) {
    if (obj[keys[index]].materia === 'Matematica') {
      total += obj[keys[index]].numeroEstudantes;
    }
  }
  return total;
