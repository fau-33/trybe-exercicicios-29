...
function somaAngulosTriangulo(anguloA, anguloB, anguloC) {
  let somaDosAngulosInternos = anguloA + anguloB + anguloC;
  let somaDosAngulosPositivos = anguloA > 0 && anguloB > 0 && anguloC > 0;
...
//console.log(somaAngulosTriangulo(100, 50, 30));
//console.log(somaAngulosTriangulo(-100, 50, 30));
//console.log(somaAngulosTriangulo(100, 50, 40));